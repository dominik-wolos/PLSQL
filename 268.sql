CREATE PACKAGE validate_graduation IS --deklaracja specyfikacji pakietu PL/SQL
...
CREATE OR REPLACE PACKAGE BODY validate_graduation IS --definicja ciała metod
